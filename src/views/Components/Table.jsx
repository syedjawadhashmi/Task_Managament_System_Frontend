...
console.log(obj.key)
	...
	addNewProject = (e) => {
		e.preventDefault();
		const { newProjectName, ProjectCode, Rate, rate_unit, customer, currency } = this.state;
	...
	render() {
		...
		console.log('asas', this.state.projects);
		return (
			<Paper className={classes.root}>
				...
				>
					...
					<DialogContent>
						<FormControl className={[ classes.formControl, 'form-control' ]} md={12} lg={12}>
							<CustomInput
								id="required"
								md={12}
								lg={12}
